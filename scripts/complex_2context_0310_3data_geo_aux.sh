...
srun -p efm_t --job-name=train_bagel_8gpu --gres=gpu:8 --ntasks-per-node=1 -quotatype=reserved apptainer exec --nv  --bind /mnt:/mnt /mnt/inspurfs/mozi_t/linjingli/apptainer/mllm3r.sif \
    bash -c 'torchrun \
      ...
      --log_every 1 \
      --results_dir /mnt/inspurfs/mozi_t/linjingli/bagel/models/complex_2context_0310_3data_geo_aux_0310 \
      --checkpoint_dir /mnt/petrelfs/linjingli/UMM_Spatial/bagel/results/train_checkpoints/complex_2context_0310_3data_geo_aux_0310 \
      --lr 2e-5 \
      --visual_und False \
      --num_workers 1 \
      --save_every 5000 \
      ...
      --geo_aux_enable True \
      --geo_aux_manifest /mnt/inspurfs/efm_t/linjingli/data/geos/complex_2context_0310_3data/manifest.json \
      --geo_aux_weight 0.05 \
