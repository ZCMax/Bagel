...
srun -p efm_t --job-name=train_bagel_8gpu --gres=gpu:8 --ntasks-per-node=1 -quotatype=reserved apptainer exec --nv  --bind /mnt:/mnt /mnt/inspurfs/mozi_t/linjingli/apptainer/mllm3r.sif \
    bash -c 'torchrun \
      ...
      --dataset_config_file ./data/configs/mix.yaml \
      --model_path /mnt/inspurfs/mozi_t/linjingli/bagel/BAGEL-7B-MoT \
      --layer_module Qwen2MoTDecoderLayer \
      --max_latent_size 64 \
      --total_steps 30000 \
      --resume-from /mnt/inspurfs/mozi_t/linjingli/bagel/models/rb0130_mix \
      --finetune_from_hf True \
      --auto_resume True \
      --resume-model-only False \
      --finetune-from-ema True \
      --log_every 1 \
      --results_dir /mnt/inspurfs/mozi_t/linjingli/bagel/models/rb0130_mix \
      --checkpoint_dir /mnt/petrelfs/linjingli/UMM_Spatial/bagel/results/train_checkpoints/rb0130_mix \
      --lr 2e-5 \
      --visual_und False \
      --num_workers 1 \
      --save_every 5000 \
