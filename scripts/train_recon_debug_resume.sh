...
name="train0906_recon"
export output_dir="/mnt/inspurfs/mozi_t/linjingli/mllm3r/model/${name}"
mkdir -p ${output_dir}
...
export PYTHONPATH="${PYTHONPATH}:/mnt/petrelfs/linjingli/mllm3r"

export HF_HOME="/mnt/petrelfs/linjingli/.cache/huggingface"
...
export wandb_name="run_bagel1.5B_qwenvl2_debugpi3"
...
--dataset_config_file /mnt/petrelfs/huwenbo/vl_res/mllm3r/data/configs/recon_test_1.yaml \
--layer_module Qwen2VLMoTDecoderLayer \
--vit_path /mnt/inspurfs/mozi_t/huwenbo/weights/qwenvl_2b_bagel_new \
--dino_path /mnt/inspurfs/mozi_t/huwenbo/weights/dinov2_large_vggt_hf \
...
--use_flex True \
--expected_num_tokens 12800 \
--max_num_tokens 12800 \
--max_num_tokens_per_sample 12800 \
